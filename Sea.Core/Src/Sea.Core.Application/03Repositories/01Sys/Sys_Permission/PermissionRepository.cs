...
{
    public class PermissionRepository : RepositoriesBase<PermissionEntity, string, PermissionDto, PermissionCreateDto, PermissionUpdateDto, ViewPermission>,
    ...
    /// 构造函数
    /// </summary>
    public PermissionRepository(IDbContextProvider<MyDbContext> _dbContextProvider, IMapper mapper) : base(_dbContextProvider, mapper)
    {
