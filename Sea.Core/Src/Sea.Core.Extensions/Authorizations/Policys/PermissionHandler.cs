...
namespace Sea.Core.Extensions.Authorizations.Policys
{
    ...
    public class PermissionHandler : AuthorizationHandler<PermissionRequirement>
    {
        ...
        public PermissionHandler(IAuthenticationSchemeProvider schemes, IHttpContextAccessor accessor, IRole2Module2PermissionAppService role2Module2PermissionAppService)
        {
            _accessor = accessor;
            Schemes = schemes;
