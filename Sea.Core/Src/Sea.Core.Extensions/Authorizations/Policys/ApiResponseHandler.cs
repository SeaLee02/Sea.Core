...
namespace Sea.Core.Extensions.Authorizations.Policys
{
    public class ApiResponseHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        protected override async Task HandleChallengeAsync(AuthenticationProperties properties)
        {
            ...
            await Response.WriteAsync(JsonSerializer.Serialize((new ApiResponse(StatusCode.CODE401)).MessageModel));
        }
        ...
        protected override async Task HandleForbiddenAsync(AuthenticationProperties properties)
        {
            ...
            await Response.WriteAsync(JsonSerializer.Serialize((new ApiResponse(StatusCode.CODE403)).MessageModel));
        }
